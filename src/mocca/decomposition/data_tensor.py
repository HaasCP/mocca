...
def get_comp_peak_data_list(relevant_comps, boundaries):
    """
...
#print(np.argmax(np.sum(peak_data_ze, axis=0)))
#display(contour_map(peak_data_ze, list(range(peak_data_ze.shape[1])),
#                    list(range(peak_data_ze.shape[0]))))
#print(np.argmax(np.sum(peak_data_ze, axis=0)))
#display(contour_map(peak_data_ze, list(range(peak_data_ze.shape[1])),
#                    list(range(peak_data_ze.shape[0]))))