...
def iterative_parafac(impure_peak, quali_comp_db, show_parafac_analytics=True):
    """
    ...
    parafac_factors_cur, boundaries_cur, comp_tensor_shape = parafac(impure_peak,
                                                                     quali_comp_db,
                                                                     iter_offset,
                                                                     show_parafac_analytics)
    ...
    if non_comp_sum_new < non_comp_sum_cur:
        ...
        # find local minimum
        while non_comp_sum_new < non_comp_sum_cur and iter_offset < iter_max:
    ...
    # if positive was wrong direction, let's go negative
        ...
        if non_comp_sum_new < non_comp_sum_cur:
            ...
            # find local minimum
            while non_comp_sum_new < non_comp_sum_cur and iter_offset > iter_min:
                non_comp_sum_cur = non_comp_sum_new
                parafac_factors_cur = parafac_factors_new
                boundaries_cur = boundaries_new
