...
If you experience bugs or general issues with ``mocca``, please have a look
...
You can help improve ``mocca`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``mocca`` documentation uses Sphinx_ as its main documentation compiler.
...
.. 
    #. Install |pre-commit|_::
       ...
       ``mocca`` comes with a lot of hooks configured to automatically help the
